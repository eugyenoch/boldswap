...
<head>
	<title>Boldswap | Cookie Policy Documentation</title>
	<meta charset="UTF-8" />
	<meta name="title" content="Boldswap| Cookie Policy" />
	<meta name="Description" content="View the Boldswapcookie policy on this page" />
	<meta name="keywords" content="Boldswapcookie policy,Earn money online, Make money online, bitcoin wallets, Education,Elearning,SME Training,Online Training,E-Learning,Manual Handling,Online Education" />
	<meta name="viewport" 
	...
	<meta property="og:title" content="Boldswap| Cookie Policy" />
	<meta property="og:description" content="View the Boldswapcookie policy on this page" />
...
<h2>Cookies set by Boldswap and other third party App</h2>
<p>The Boldswap website also makes use of services offered by third party websites such as Jetpack, and webmaster tools amongst others to enhance the experience of visitors. These include social media platforms such as Facebook and Twitter (through the use of sharing buttons). As a result, cookies may be set by these third parties, and used by them to track your online activity. We have no direct control over the information that is collected by these cookies.<br>
Cookies are used by Boldswapand other third party Apps running on the Boldswapwebsite in a variety of different ways. The cookies set will depend features that are enabled. The cookies are only set when a user interacts with one of these, or to allow admin functions.</p>
